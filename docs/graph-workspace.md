...
The workspace stores an ordered `Vec<GraphEntry>` with a limit of 16. Each entry contains a run-unique, monotonically increasing `GraphId` and one `GraphSlot` source.
